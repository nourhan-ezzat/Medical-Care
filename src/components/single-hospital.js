...
import { faStar,  faBuilding,  faMap, faPhone, faBookmark, faHeart, faHospital} from '@fortawesome/free-solid-svg-icons';

import Breadcrumb from './breadcrumb';
import FilterSinglePage from './filter-single-service';
import AddReviewSingle from './add-review-single';

class SingleHospital extends Component {
    render() { 
        return ( 
          <section >
            <Breadcrumb/> 
            <div className="container">
              <h1 className="pt-4 text-black mb-0">Hospital One</h1>
                ...
                <div className="col-lg-8 col-md-8 pl-0 mb-4">
                  ...
                  <div className="shadow">
                    <img src="../../images/counter_bg.jpg" className="img-fluid"/>
                      ...
                      <span style={{color: "#2196F3"}}>
                        ...
                        <span className="ml-1">Hospital</span>
                      </span>
                      </div>
                  </div>
                  ...
                  <div className="shadow bg-white mt-4 p-4">
                    <h4 className="text-black border-bottom pb-3" style={{fontSize: "20px"}}>
                      <FontAwesomeIcon icon={faHospital} className="text-green mr-2"/>
                      About Hospital
                    </h4>
