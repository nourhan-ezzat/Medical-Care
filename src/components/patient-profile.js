...
class PatientProfile extends Component {
    // componentDidMount(){
    //     $(".modal").css({"display": "none", "overflow-y": "show"});
        ...
        <section>
            ...
            <div className="container">
                <div className="row my-5">
                    <div className="col-lg-3 col-md-3 smallTab">
                    ...
                    <div className="col-lg-9 col-md-9">
                        <div className="tab-content border" id="v-pills-tabContent" style={{borderRadius: ".25rem"}}>
                            ...
                            <div className="tab-pane fade show active px-lg-2" id="v-pills-appointments" role="tabpanel" aria-labelledby="v-pills-appointments-tab">
                                ...
                                <form>
                                    <div className="form-group">
                                        <div className="row mb-3">
                                            <div className="col-lg-6 col-md-6 mb-sm-2">
                                ...
                                <form>
                                    <div className="form-group">
                                        <div className="row mb-3">
                                            ...
                                            <div className="col-lg-9 col-md-9">
                                                <input type="text" className="form-control contact-form" value="Nourty" readOnly/>
                                            </div>
                                        </div>
                                        <div className="row mb-3">
                                            <div className="col-lg-3 col-md-3">
                                            ...
                                            <div className="col-lg-9 col-md-9">
                                                <input type="text" className="form-control contact-form" value="Nourhan Mohamed" readOnly/>
                                            </div>
                                        </div>
                                        <div className="row mb-3">
                                            <div className="col-lg-3 col-md-3">
                                            ...
                                            <div className="col-lg-9 col-md-9">
                                                <input type="text" className="form-control contact-form" value="01152626567" readOnly/>
                                            </div>
                                        </div>
                                        <div className="row mb-3">
                                            <div className="col-lg-3 col-md-3">
                                            ...
                                            <div className="col-lg-9 col-md-9">
                                                <input type="text" className="form-control contact-form" value="Haram, Giza" readOnly/>
                                            </div>
                                        </div>
                                    </div>
                                </form>
