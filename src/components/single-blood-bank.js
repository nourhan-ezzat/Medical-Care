...
import { faStar,  faBuilding,  faMap, faPhone, faBookmark, faHeart, faFirstAid } from '@fortawesome/free-solid-svg-icons';
            ...
            <div className="container">
              ...
              <div className="row mt-3">
                ...
                <div className="col-lg-8 col-md-8 pl-0 mb-4">
                  ...
                  <div className="shadow">
                    <img src="../../images/counter_bg.jpg" className="img-fluid"/>
                      ...
                      <span style={{color: "#2196F3"}}>
                        ...
                        <span className="ml-1">Blood Bank</span>
                      </span>
                      </div>
                  </div>
                  {/* Blood Bank Main Info End */}

                  {/* Blood Bank Desc Start */}
                  <div className="shadow bg-white mt-4 p-4">
                    <h4 className="text-black border-bottom pb-3" style={{fontSize: "20px"}}>
                      <FontAwesomeIcon icon={faFirstAid} className="text-green mr-2"/>
                      About Blood Bank
                    </h4>
                  ...
                  {/* Blood Bank Departments Start */}
                  <div className="shadow bg-white mt-4 p-4">
                    <h4 className="text-black border-bottom pb-3" style={{fontSize: "20px"}}>
                      <FontAwesomeIcon icon={faBuilding} className="text-green mr-2"/>
                      Blood Bank Departments
                    </h4>
                    <Link to="/single-specialist" title="Single Specialist" className="text-decoration-none">
                      <span className="text-green h5 ml-1">A+ .. </span>
                    </Link>
                    <Link to="/single-specialist" title="Single Specialist" className="text-decoration-none">
                      <span className="text-green h5 ml-1">B+ .. </span>
                    </Link>
                    <Link to="/single-specialist" title="Single Specialist" className="text-decoration-none">
                      <span className="text-green h5 ml-1">AB-</span>
                    </Link>
                  </div>
                  {/* Blood Bank Departments Start */}
                  
                  {/* Blood Bank Location Start */}
                  <div className="shadow bg-white mt-4 p-4">
                    <h4 className="text-black border-bottom pb-3" style={{fontSize: "20px"}}>
                  ...
                  {/* Blood Bank Location End */}

                  {/* Blood Bank Reviews & Rating Start */}
                  <div className="shadow bg-white mt-4 p-4">
                ...
                {/* Blood Bank Filter Start */}
                <div className="col-lg-4 col-md-4">
                  <FilterSinglePage/>
                </div>
                {/* Blood Bank Filter End */}
              </div>
            </div>    
          </section>  
        );
